            ...
            <Box>
                <Container my={36}>
                    ...
                    <Stepper active={active} onStepClick={setActive} breakpoint="sm">
                        <Stepper.Step
                            label="Get started"
                            description="Set essential loan details such as loan title, target and currency"
                        >
                            ...
                            <Paper {...paperProps}>
                                <Title {...subTitleProps}>Your location</Title>
                                <Text size="sm" mb="sm">Please select the country where the loan will be processed. This helps match you to the correct payment processors.</Text>
                                <SimpleGrid cols={2} breakpoints={[{maxWidth: 'sm', cols: 1}]}>
                                    <CountrySelect/>
                            ...
                            <Paper {...paperProps}>
                                <Stack spacing="sm">
                                    <Title {...subTitleProps}>Loan information</Title>
                                    <CurrencySelect/>
                                    <Radio.Group
                                        label="What kind of loan would you like to create?"
                                        value={target}
                                        onChange={setTarget}
                                    >
                                        <Group mt="xs">
